  ...
  function (t, n, i) {
    ...
    function _(t, n, i, e, r) {
      for (var o, s = [n, i]; s.length; )
        (i = s.pop()) - (n = s.pop()) <= e ||
          ((o = n + Math.ceil((i - n) / e / 2) * e), a(t, o, n, i, r), s.push(n, o, o, i));
    }
    e.prototype = {
      all: function () {
      ...
      search: function (t) {
        ...
        for (var e, r, o, s, h = []; n; ) {
          for (e = 0, r = n.children.length; e < r; e++)
            (o = n.children[e]),
              d(t, (s = n.leaf ? a(o) : o)) &&
                (n.leaf ? i.push(o) : f(t, s) ? this._all(o, i) : h.push(o));
          n = h.pop();
        }
        return i;
      },
      ...
      remove: function (t, n) {
        ...
        for (var i, a, e, o, s = this.data, h = this.toBBox(t), l = [], c = []; s || l.length; ) {
          if (
            (s || ((s = l.pop()), (a = l[l.length - 1]), (i = c.pop()), (o = !0)),
      ...
      _build: function (t, n, i, a) {
        ...
        a || ((a = Math.ceil(Math.log(r) / Math.log(s))), (s = Math.ceil(r / Math.pow(s, a - 1)))),
          ((e = p([])).leaf = !1),
          (e.height = a);
        var h,
          l,
        ...
        for (_(t, n, i, f, this.compareMinX), h = n; h <= i; h += f)
          for (_(t, h, (c = Math.min(h + f - 1, i)), m, this.compareMinY), l = h; l <= c; l += m)
            (u = Math.min(l + m - 1, c)), e.children.push(this._build(t, l, u, a - 1));
          ...
          for (; r > e; ) {
            if (r - e > 600) {
              var s = r - e + 1,
                ...
                u = 0.5 * Math.sqrt((l * c * (s - c)) / s) * (h - s / 2 < 0 ? -1 : 1),
      ...
      var n = (t.Layer ? t.Layer : t.Class).extend({
        ...
        _addMarker: function (n, i, a) {
          ...
          var e = this._map.latLngToContainerPoint(i),
            ...
            s = r[1] / 2,
            h = [
              { minX: e.x - o, minY: e.y - s, maxX: e.x + o, maxY: e.y + s, data: n },
        ...
        _redraw: function (t) {
          ...
          if (this._map) {
            ...
            var i = [];
            n._latlngMarkers.dirty / n._latlngMarkers.total >= 0.1 &&
              (n._latlngMarkers.all().forEach(function (t) {
                i.push(t);
              }),
            ...
            n._latlngMarkers.search(e).forEach(function (t) {
              var a = n._map.latLngToContainerPoint(t.data.getLatLng()),
                ...
                r = e[0] / 2,
                o = e[1] / 2,
                s = { minX: a.x - r, minY: a.y - o, maxX: a.x + r, maxY: a.y + o, data: t.data };
        ...
        _executeListeners: function (t) {
          ...
          e && e.length > 0
            ? ((n._map._container.style.cursor = "pointer"),
              ...
              "mousemove" === t.type &&
                (e[0].data.getTooltip() && ((n._openToolTip = e[0].data), e[0].data.openTooltip()),
